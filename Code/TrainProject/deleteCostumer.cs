...
namespace TrainProject
{
    public partial class deleteCostumer : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-SUP54T1;Initial Catalog=TrianBooking;Integrated Security=True");
            SqlCommand cmd = new SqlCommand("delete  from costumer where costumer_id=@id", con);
        ...
        private void deleteCostumer_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'trianBookingDataSet4.costumer' table. You can move, or remove it, as needed.
            this.costumerTableAdapter1.Fill(this.trianBookingDataSet4.costumer);
